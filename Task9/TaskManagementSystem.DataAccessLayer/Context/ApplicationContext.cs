    ...
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Task>().HasData(
                new Task[]
                {
                    new Task { Id = 1, Name ="Create", CreatorId=1, PerformerId=2, Description="", Status=Statuses.NotStarted},
                    new Task { Id = 2, Name ="Push", CreatorId=2, PerformerId=3, Description="", Status=Statuses.NotStarted},
                    new Task { Id = 3, Name ="Delete", CreatorId=3, PerformerId=4, Description="", Status=Statuses.NotStarted},
                    new Task { Id = 4, Name ="Read", CreatorId=4, PerformerId=5, Description="", Status=Statuses.NotStarted},
                    new Task { Id = 5, Name ="Edit", CreatorId=5, PerformerId=1, Description="", Status=Statuses.NotStarted},
